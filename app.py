# Python 程式碼 V10.1 (React 佈局完美復刻版)
...
# --- 渲染函式 (使用 textwrap.dedent 解決縮排問題) ---
def render_dashboard_content(day_stats, supp_list, med_list, current_date_str):
    icons = {
    ...
    # 這裡使用 textwrap.dedent 來確保 HTML 沒有多餘縮排
...
# ----------------------------------------------------
# 建立左右兩欄
col_dash, col_input = st.columns([4, 3], gap="large")
